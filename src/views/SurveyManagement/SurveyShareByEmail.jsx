...
const SurveyShareByEmail = () => {
    ...
    //             const excelCategory = (respondent.category || "").trim();
    //             const foundCategory = filteredCategories.find(
    //                 (cat) => cat.categoryName.trim().toLowerCase() === excelCategory.toLowerCase()
    //             );
    //             if (!foundCategory) {
    ...
    //             return {
    //                 ...respondent,
    //                 category: foundCategory ? foundCategory._id : "",
    //             };
    //         });
    ...
    //     axios.put(process.env.REACT_APP_BACKEND_URL + '/survey-responses/add-respondent', addRespondentsData)
    //         .then(res => {
